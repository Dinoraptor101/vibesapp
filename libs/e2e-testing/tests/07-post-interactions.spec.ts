...
import {
  setupReportTestEnvironment,
  createUserForReporting,
  createPostForReporting,
  reportPostAPI,
  getApiHeaders,
  TEST_LOCATION_API,
} from './helpers/report-post';
...
test.describe('Report Post - API Tests', () => {
  ...
  test.beforeAll(async ({ request }) => {
    ...
    const setup = await setupReportTestEnvironment(request);
    baseURL = setup.baseURL;
    testPostId = setup.testPostId;
    postAuthor = setup.postAuthor;
  });
