    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          className="min-w-[220px] bg-surface-elevated border border-border rounded-lg shadow-xl p-1 z-50 animate-in fade-in-0 zoom-in-95"
          sideOffset={8}
          align="end"
        >
          {/* User Info */}
          ...
          <DropdownMenu.Sub>
            ...
            <DropdownMenu.Portal>
              <DropdownMenu.SubContent
                className="min-w-[160px] bg-surface-elevated border border-border rounded-lg shadow-xl p-1 z-50 animate-in fade-in-0 zoom-in-95"
                sideOffset={8}
              >
                <DropdownMenu.Item
                  className="flex items-center gap-3 px-3 py-2 text-sm text-text-primary rounded-md hover:bg-surface-hover cursor-pointer outline-none focus:bg-surface-hover"
