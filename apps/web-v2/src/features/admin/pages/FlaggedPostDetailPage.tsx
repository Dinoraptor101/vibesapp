...
export function FlaggedPostDetailPage() {
  ...
  useEffect(() => {
    ...
    // Fallback: fetch all flagged posts and find the one we need
    ...
    return (
      <AdminLayout>
        <div className="max-w-4xl mx-auto p-4">
          <Button variant="ghost" onClick={() => navigate('/admin/flagged')} className="mb-4">
      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        <div className="mt-6 space-y-4">
          ...
          <Card>
            <CardContent className="p-4 bg-white dim:bg-gray-800 dark:bg-gray-900">
              ...
              {post.isHidden ? (
                ...
                <p className="text-yellow-600 dim:text-yellow-400 dark:text-yellow-400">
          ...
          <div className="flex gap-3 pt-4">
            <Button variant="secondary" onClick={() => navigate('/admin/flagged')}>
              Back to List
            </Button>
