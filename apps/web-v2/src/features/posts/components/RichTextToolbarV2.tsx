...
interface RichTextToolbarV2Props {
...
export function RichTextToolbarV2({ editorRef, className }: RichTextToolbarV2Props) {
  ...
  const handleBulletList = () => {
    ...
    // Fix alignment after bullet list (browser bug workaround)
    if (!document.queryCommandState('insertUnorderedList')) {
      // List was just removed, restore left alignment
      if (alignState !== 'left') {
        ...
        document.execCommand(commandMap[alignState], false);
      }
    }
  };
  ...
  return (
    ...
    >
      ...
      <button
        ...
        title="Bullet list"
      >
        <List className={getIconClass(isList)} />
      </button>
